...
abstract class ExerciseService {
  ...
  @GET('/bodyparts')
  Future<HttpResponse<ApiResponseDto<NameItemDto>>> getBodyParts();

  @GET('/equipments')
  Future<HttpResponse<ApiResponseDto<NameItemDto>>> getEquipments();

  @POST('/workouts/generate')
  Future<HttpResponse<ApiSingleResponseDto<GenerateWorkoutDto>>>
  generateWorkout(@Body() Map<String, dynamic> request);
}
