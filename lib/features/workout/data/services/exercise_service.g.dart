...
class _ExerciseService implements ExerciseService {
  ...
  @override
  Future<HttpResponse<ApiSingleResponseDto<GenerateWorkoutDto>>>
  generateWorkout(Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options =
        _setStreamType<HttpResponse<ApiSingleResponseDto<GenerateWorkoutDto>>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiSingleResponseDto<GenerateWorkoutDto> _value;
    try {
      _value = ApiSingleResponseDto<GenerateWorkoutDto>.fromJson(
        _result.data!,
        (json) => GenerateWorkoutDto.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
