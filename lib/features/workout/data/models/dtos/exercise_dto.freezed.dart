...
class _$ExerciseDtoImpl implements _ExerciseDto {
  ...
  @override
  String toString() {
    return 'ExerciseDto(exerciseId: $exerciseId, name: $name, gifUrl: $gifUrl, description: $description, targetMuscles: $targetMuscles, bodyParts: $bodyParts, equipments: $equipments, secondaryMuscles: $secondaryMuscles, instructions: $instructions)';
  }
