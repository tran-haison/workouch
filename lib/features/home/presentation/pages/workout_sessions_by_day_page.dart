                        ...
                        Wrap(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                '${session.totalDurationMinutes.toStringAsFixed(1)} ${AppConstants.mins.toLowerCase()} • '
                                '${session.totalVolumeKg.toStringAsFixed(1)} ${AppConstants.kg.toLowerCase()} • '
                                '${session.totalExercises} ${AppConstants.exercises.toLowerCase()}',
